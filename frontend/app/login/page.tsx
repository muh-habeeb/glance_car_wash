          ...
          >
            ...
            <div className="space-y-1 relative">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 top-4 flex items-center pr-3.5 text-midgray hover:text-slate-800 dark:hover:text-white transition-colors cursor-pointer"
                tabIndex={-1}

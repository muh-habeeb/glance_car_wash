...
export default function ErrorDisplay({ 
  ...
  return (
    <div 
      className="bg-red-950/20 border border-red-500/30 rounded-xl p-4 mb-6 text-sm relative overflow-hidden transition-all duration-300"
      role="alert"
      aria-live="assertive"
    >
      ...
      <div className="pl-2">
        <h3 className="font-bold text-red-400 text-sm tracking-wide uppercase flex items-center mb-2">
